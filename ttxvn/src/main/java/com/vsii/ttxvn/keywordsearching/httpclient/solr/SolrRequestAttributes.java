...
public class SolrRequestAttributes {
	...
	/**
	 * Gets max segments. Used to optimize down to at most this number of
	...
	/**
	 * Sets max segments. Used to optimize down to at most this number of
	 * segments. Defaults to '1'.
	 */
	...
	/**
	 * Gets whether or not to wait flush. Will block until index changes are
	 * flushed to disk. Defaults to <code>true</code>.
	 */
	...
	/**
	 * Sets whether or not to wait flush. Will block until index changes are
	 * flushed to disk. Defaults to <code>true</code>.
	 */
	...
	/**
	 * Gets whether or not to wait for the searcher. Will block until a new
	 * searcher is opened and registered as the main query searcher, making the
	 * changes visible. Defaults to <code>true</code>.
	 */
	...
	/**
	 * Sets whether or not to wait for the searcher. Will block until a new
	 * searcher is opened and registered as the main query searcher, making the
	 * changes visible. Defaults to <code>true</code>.
	 */
